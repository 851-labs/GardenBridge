...
This document outlines how to ship a new macOS release for GardenBridge, including Sparkle updates and Homebrew distribution.
...
shasum -a 256 /path/to/GardenBridge.dmg
```
...
```
git add Casks/gardenbridge.rb
git commit -m "bump gardenbridge to 1.0.0"
git push
```
